package onemessageui.widght.FlippingImageView;
...
import onemessageui.widght.FlippingImageView.RotateAnimation.Mode;
...
public class FlippingImageView extends AppCompatImageView {
    ...
    public void clearRotateAnimation() {
        if (mIsHasAnimation) {
            setAnimation(null);
