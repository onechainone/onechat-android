...
package onemessageui.mpush.supertoast.utils;

import android.content.Context;
import android.preference.PreferenceManager;

import sdk.android.onechatui.R;
import onemessageui.mpush.supertoast.Style;
...
public class AttributeUtils {
    ...
    public static int getDuration(Context context) {
        switch (PreferenceManager.getDefaultSharedPreferences(context).getInt(context
                .getResources().getString(R.string.tab_title_exchange), 0)) {
            case 0:
    ...
    public static int getFrame(Context context) {
        switch (PreferenceManager.getDefaultSharedPreferences(context).getInt(context
                .getResources().getString(R.string.tab_title_exchange), 0)) {
            case 0:
                return Style.FRAME_STANDARD;
            case 1:
                return Style.FRAME_KITKAT;
            case 2:
                return Style.FRAME_LOLLIPOP;
            default:
                return Style.FRAME_STANDARD;
        }
    }
    ...
    public static int getAnimations(Context context) {
        switch (PreferenceManager.getDefaultSharedPreferences(context).getInt(context
                .getResources().getString(R.string.tab_title_exchange), 0)) {
            case 0:
                return Style.ANIMATIONS_FADE;
            case 1:
                return Style.ANIMATIONS_FLY;
            case 2:
                return Style.ANIMATIONS_SCALE;
            case 3:
                return Style.ANIMATIONS_POP;
            default:
                return Style.ANIMATIONS_FADE;
        }
    }
    ...
    public static int getType(Context context) {
        switch (PreferenceManager.getDefaultSharedPreferences(context).getInt(context
                .getResources().getString(R.string.tab_title_exchange), 0)) {
            case 0:
                return Style.TYPE_STANDARD;
            case 2:
                return Style.TYPE_PROGRESS_BAR;
            case 3:
                return Style.TYPE_PROGRESS_CIRCLE;
            default:
                return Style.TYPE_STANDARD;
        }
    }
