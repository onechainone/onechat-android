...
//        amountView.setTextColor(WalletApplication.getInstance().getResources().getColor(color));
//        symbolView.setTextColor(WalletApplication.getInstance().getResources().getColor(color));
    }
