...
public class UnlockWalletDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            passwordView.setBackground(getResources().getDrawable(R.drawable.edit_text_line_bg));
        } else {
            passwordView.setBackgroundDrawable(getResources().getDrawable(R.drawable.edit_text_line_bg));
        }
