...
package onewalletui.onekeyshare.themes.classic;
...
import onewalletui.onekeyshare.OnekeyShareThemeImpl;
import onewalletui.onekeyshare.themes.classic.land.EditPageLand;
import onewalletui.onekeyshare.themes.classic.land.PlatformPageLand;
import onewalletui.onekeyshare.themes.classic.port.EditPagePort;
import onewalletui.onekeyshare.themes.classic.port.PlatformPagePort;
...
public class ClassicTheme extends OnekeyShareThemeImpl {
    ...
    protected void showPlatformPage(Context context) {
        ...
        long currentTime = TimeUtils.getTrueTime();
