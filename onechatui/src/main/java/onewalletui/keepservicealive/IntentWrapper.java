package onewalletui.keepservicealive;
...
import oneapp.onechat.oneandroid.onewallet.keepservicealive.DaemonEnv;
...
public class IntentWrapper {
    ...
    public static List<IntentWrapper> whiteListMatters(final Activity a, String reason) {
        ...
        if (reason == null) reason = a.getString(R.string.keep_service_alive_reason);
                ...
                case DOZE:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        new AlertDialog.Builder(a)
                                .setCancelable(false)
                                .setTitle(String.format(a.getString(R.string.white_list_tip_title_power), getApplicationName()))
                                .setMessage(String.format(a.getString(R.string.white_list_tip_msg_power), reason, getApplicationName()))
                                .setPositiveButton(a.getString(R.string.button_ok), new DialogInterface.OnClickListener() {
...
//                            })
//                            .show();
//                    showed.icon_recive_red(iw);
                    break;
                case ZTE_GOD:
                case HUAWEI_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_close_screen_clean), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_close_screen_clean), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                            })
                            .setNegativeButton(a.getString(R.string.button_cancel), null).show();
                    showed.add(iw);
                    break;
                case XIAOMI_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_xiaomi_hide_model), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_close_screen_clean), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
...
//                    showed.icon_recive_red(iw);
                ...
                case MEIZU:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_run_backend), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_run_backend), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case MEIZU_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_run_backend), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_run_backend_meizu), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
...
//                    showed.icon_recive_red(iw);
                ...
                case VIVO_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_run_backend), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_run_backend_vivo), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case GIONEE:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_green_backend), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_green_backend), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case LETV_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_run_backend), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_run_not_clean_backend), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case LENOVO:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_run_backend), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_run_backend_lenovo), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
                ...
                case LENOVO_GOD:
                    new AlertDialog.Builder(a)
                            .setCancelable(false)
                            .setTitle(String.format(a.getString(R.string.white_list_tip_title_run_backend), getApplicationName()))
                            .setMessage(String.format(a.getString(R.string.white_list_tip_msg_run_backend_lenovo_god), reason, getApplicationName()))
                            .setPositiveButton(a.getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface d, int w) {
                                    iw.startActivitySafely(a);
                                }
